  ...
  return (
    <>
        <div className='text-white w-5/12 mx-auto flex flex-col justify-between items-center gap-3 mt-10'>
            <h1 className='text-[#f1f2ff] text-[28px] leading-[32px] text-center'>Welcome to Event Logger of MJPRU ! For the best experience, please 
            ...
            <div className='w-6/12 mx-auto flex justify-between items-center cursor-pointer mt-10'>
                <Link to="/events">
                    <div className='flex flex-col items-center gap-y-3 text-[22px] font-[600] font-inter 
                        ...
                        <Link to={"/events"} className='text-[#e37222] group-hover:text-richblack-50'>Search Events</Link>
                    </div>
                </Link>
                <Link to="">
                    <div className='flex flex-col items-center gap-y-3 text-[22px] font-[600] font-inter 
                        ...
                        <Link to={"/user-profile"} className='text-[#e37222] group-hover:text-richblack-50'>My Event</Link>
                    </div>
                </Link>
            <Link to="">
                    <div className='flex flex-col items-center gap-y-3 text-[22px] font-[600] font-inter 
                        ...
                        <Link to={"/user-profile"} className='text-[#006699] group-hover:text-richblack-50'>Manage Events</Link>
                    </div>
            </Link>
            <Link to="/create-event">
                    <div className='flex flex-col items-center gap-y-3 text-[22px] font-[600] font-inter 
                        ...
                        <Link to={"/create-event"} className='text-[#669933] group-hover:text-richblack-50'>Create Event</Link>
                    </div>
            </Link>
            </div>
                    ...
                    <div className='rounded-[4px] border border-richblack-100 p-6 flex flex-col gap-y-4'>
                        <h2 className='text-[32px] font-[600] font-inter leading-[40px] text-yellow-100'>Past Events</h2>
                                ...
                                <h5  className='text-[rgba(131,136,148,1)] font-inter font-[500] text-[16px] 
                                     leading-[24px] border-b-2 rounded-[8px] p-1 hover:text-yellow-300'>{event.title}</h5></Link>
                            ))}
                    </div>
