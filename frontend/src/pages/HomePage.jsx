...
const HomePage = ({isLoggedIn}) => {
  ...
  return (
    ...
    <div className='text-white w-5/12 mx-auto flex flex-col justify-between items-center gap-3 mt-10'>
        <h1 className='text-richblack-5 text-[28px] leading-[32px]'>Welcome to vTools ! For the best experience, please 
        ...
        <p className='text-[24px] leading-[32px]'>Don't have one? <span className='text-pink-400'><i>Create one here!</i></span></p>
    </div>
