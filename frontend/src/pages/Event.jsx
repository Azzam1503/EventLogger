    ...
    <div className="w-full flex justify-center mt-4">
      <div className="w-full max-w-5xl flex md:flex-row flex-col-reverse justify-between gap-14 px-5 sm:px-14 lg:px-0">
        <div className="md:w-1/2 w-full">
          <h1 className="text-[#e37222] dark:text-richblack-700 text-[32px] font-[600] font-inter leading-[40px] pt-6">
            {event.title}
          </h1>
          <hr className="text-richblack-200 w-full" />
          <p
            className="text-[#f5f5f5] text-[16px] font-[500] font-inter leading-[24px] mt-6
                            dark:text-richblack-600"
          >
            {event.description}
          </p>
          <br />
          ...
          <div>
            <div className="flex gap-x-3">
              ...
              <h1 className="text-[#e37222] dark:text-[#e84949] text-[24px] font-[600] font-inter leading-[28px] mt-6">
                LOCATION
              </h1>
            </div>
            <h3
              className="text-richblack-50 text-[18px] font-[500] font-inter leading-[24px] mt-6
                                    dark:text-richblack-600"
            >
              {event.venue}
            </h3>
            ...
            event.speakers.map((speaker) => (
              <div key={speaker._id} className="pb-12">
                <div className="flex gap-x-3">
                  ...
                  <h3 className="text-[#e37222] dark:text-[#e84949] text-[28px] font-[600] font-inter leading-[28px] mt-6">
                    Speaker
                  </h3>
                </div>
                <div className="flex gap-x-3">
                  ...
                  <h3
                    className="text-[#f5f5f5] text-[24px] font-[600] font-inter leading-[28px] mt-6
                                    dark:text-[#006699]"
                  >
                    {speaker.name}
                  </h3>
                ...
                <div className="flex gap-3">
                  ...
                  <h5
                    className="text-richblack-25 text-[16px] font-[500] font-inter leading-[24px] mt-4
                                      dark:text-richblack-600"
                  >
                    {speaker.about}
                  </h5>
        ...
        <div className="flex flex-col items-center mt-8 w-full md:w-1/2">
          ...
          <div className="flex font-bold text-3xl mt-6 justify-between gap-x-12">
            {user && event.userId === user.id && (
              <Link
                className="border border-richblack-700 rounded-[8px] bg-richblack-800  text-[#006699] p-2 
            ...
            {user && event.userId === user.id && (
              <div
                className="border border-richblack-700 rounded-[8px] bg-richblack-800 text-pink-400 p-2 
                    shadow-[2px_2px_0px_0px_rgba(255,255,255,0.18)] first-line: hover:shadow-none hover:scale-95 transition-all 
                       duration-200 dark:bg-white dark:border-none"
              >
                <MdDelete
